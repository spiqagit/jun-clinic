...
<meta name="twitter:title" content="コラム |  CLINIC" />
                ...
                if (!empty($related_menus)) {
                    foreach ($related_menus as $menu) {
                        if (!in_array($menu->ID, $displayed_posts)) {
                            ...
                            $is_active = ($menu_title === $search_result_string) ? ' class="is_active"' : '';
                            echo '<li' . $is_active . '><a href="' . home_url() . '/column/?s=&theme=' . $menu->ID . '">' . $menu_title . '</a></li>';
                        }
                    }
                }
            }
